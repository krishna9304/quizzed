...
docker run -d --name $CONTAINER1_NAME $IMAGE1_NAME -p 8081:8001 --env-file=apps/auth/.env
docker run -d --name $CONTAINER2_NAME $IMAGE2_NAME -p 8080:8000 --env-file=apps/quiz/.env
